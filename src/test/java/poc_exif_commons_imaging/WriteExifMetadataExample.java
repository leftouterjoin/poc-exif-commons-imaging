	...
	public void changeExifMetadata(File jpegImageFile, File dst)
		...
		try {
				...
				outputSet = new TiffOutputSet();
			{
				...
				exifDirectory.add(ExifTagConstants.EXIF_TAG_APERTURE_VALUE, RationalNumber.valueOf(3));
			}
			{
	...
	public void removeExifTag(File jpegImageFile, File dst) throws IOException,
		...
		try {
			...
			if (null == outputSet) {
				...
				IOUtils.copy(new FileInputStream(jpegImageFile), new FileOutputStream(dst));
				return;
			}
			{
